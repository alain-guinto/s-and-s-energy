...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden py-20 md:py-0">
      ...
      <div className="container mx-auto px-6 relative z-20 text-white pt-20 md:pt-32">
        <div className="max-w-4xl animate-fade-in-down">
          <div className="inline-flex items-center space-x-3 mb-6 md:mb-8 bg-white/5 backdrop-blur-xl px-4 py-2 md:px-6 md:py-3 rounded-full border border-white/10 shadow-2xl">
            <span className="flex h-3 w-3 relative">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-yellow-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-3 w-3 bg-yellow-500"></span>
            </span>
            <h2 className="text-yellow-400 text-[10px] md:text-sm font-black uppercase tracking-[0.2em] md:tracking-[0.3em]">
              The Gold Standard in Solar
            </h2>
          </div>

          <h1 className="text-4xl sm:text-5xl md:text-9xl font-black leading-tight md:leading-[0.9] mb-6 md:mb-10 drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]">
            Powering a <br />
            <span className="text-yellow-500 energy-text-glow">Smarter</span> Future
          </h1>

          <p className="text-lg md:text-3xl text-blue-50 mb-10 md:mb-14 max-w-3xl leading-relaxed opacity-95 font-medium border-l-4 border-yellow-500 pl-6 md:pl-8">
            Advanced Microinverter solutions for the Filipino household. <br className="hidden md:block" />
            <span className="text-yellow-400 font-black block md:inline mt-2 md:mt-0">25-Year Reliability. 100% Peace of Mind.</span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-8">
            <a
              ...
              className="group relative overflow-hidden bg-yellow-500 text-blue-950 px-8 py-4 md:px-12 md:py-6 rounded-2xl md:rounded-3xl font-black text-lg md:text-xl hover:bg-yellow-400 transition-all text-center shadow-[0_25px_60px_rgba(234,179,8,0.4)] hover:-translate-y-1.5 active:translate-y-0"
            >
            ...
            <a
              ...
              className="bg-white/10 backdrop-blur-2xl border-2 border-white/20 text-white px-8 py-4 md:px-12 md:py-6 rounded-2xl md:rounded-3xl font-black text-lg md:text-xl hover:bg-white/20 transition-all text-center hover:border-white/50 shadow-xl"
            >
              Calculate ROI
            </a>
          </div>
